...
MongoClient.connect(
    'mongodb+srv://ahyoon:0412@cluster0.gbv0x.mongodb.net/myFirstDatabase?retryWrit' +
            'es=true&w=majority',
    {
...
app.get(
    "/sign_up_info_teacher",
    (req, res) => res.render("sign_up_info_teacher")
);


//$$$$$$$$테스트용
app.get("/ct", (req, res) => res.render("class_teacher.html"));
app.get("/cs", (req, res) => res.render("class_student.html"));
// $$$$$$테스트용
...
app.get("/student_enter_room", (req, res) => {
    res.render("student_enter_room.ejs");
...
app.get('/create_course', function (req, res) {
    db
        ...
        .toArray(function (err, result) {
            ...
            //create course 렌더링과 동시에 array값들 넘겨줌 res.render('create_course.ejs');
        })
});
//api/course 즉 강의개설 post 요청시 실행.
app.post('/api/courses', function (req, res) {
    db
        .collection('course_counter')
        .findOne({
            name: 'Total Course'
        }, function (err, result) {
...
// app.post('/api/course',(req,res)=> {   res.send('전송완료');
// console.log(req.body); })
